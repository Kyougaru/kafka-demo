package com.kyougaru.account.query.api.controllers;

import com.kyougaru.account.query.api.dto.AccountLookupResponse;
import com.kyougaru.account.query.api.dto.EqualityType;
import com.kyougaru.account.query.api.queries.FindAccountByHolderQuery;
import com.kyougaru.account.query.api.queries.FindAccountByIdQuery;
import com.kyougaru.account.query.api.queries.FindAccountWithBalanceQuery;
import com.kyougaru.account.query.api.queries.FindAllAccountsQuery;
import com.kyougaru.account.query.domain.BankAccount;
import com.kyougaru.cqrs.core.infrastructure.QueryDispatcher;
